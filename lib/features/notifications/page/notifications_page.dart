              ...
              child: Column(
                ...
                children: [
                  ...
                  NotificationTile(
                    ...
                    onChanged: (value) {
                      settings = settings.copyWith(orderUpdates: value);
                  ...
                  NotificationTile(
                    ...
                    onChanged: (value) {
                      settings = settings.copyWith(promotions: value);
                      provider.updateSettings(settings);
                    },
                  ),
                  ...
                  NotificationTile(
                    title: "New Arrivals",
                    subtitle: "Get notified about new collections.",
                    icon: Icons.new_releases,
                    value: settings.newArrivals,
                    onChanged: (value) {
                      settings = settings.copyWith(newArrivals: value);
                      provider.updateSettings(settings);
                    },
                  ),
                  ...
                  NotificationTile(
                    title: "Back In Stock",
                    subtitle: "Receive stock availability alerts.",
                    icon: Icons.inventory_2,
                    value: settings.backInStock,
                    onChanged: (value) {
                      settings = settings.copyWith(backInStock: value);
                      provider.updateSettings(settings);
                    },
                  ),
                  ...
                  NotificationTile(
                    ...
                    subtitle: "Receive updates through SMS.",
                    icon: Icons.sms_outlined,
                    value: settings.smsNotifications,
                    onChanged: (value) {
                      settings = settings.copyWith(smsNotifications: value);
                      provider.updateSettings(settings);
                    },
                  ),
