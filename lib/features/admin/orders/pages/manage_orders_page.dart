...
class AdminManageOrdersPage extends StatefulWidget {
  ...
  @override
  State<AdminManageOrdersPage> createState() =>
      _ManageOrdersPageState();
}

class _ManageOrdersPageState
    extends State<AdminManageOrdersPage> {
...
Widget build(BuildContext context) {
  ...
  final filterProvider =
    context.watch<AdminOrderFilterProvider>();

final orders =
    filterProvider.apply(orderProvider.orders);
  // Statistics
  final totalOrders = orders.length;

  final pendingOrders = orders.where(
    (e) => e.orderStatus == OrderStatus.placed,
  ).length;
  ...
  final deliveredOrders = orders.where(
    (e) => e.orderStatus == OrderStatus.delivered,
  ).length;

  final revenue = orders
      .where(
        (e) => e.paymentStatus == PaymentStatus.paid,
      )
      .fold<double>(
        0,
