...
class InvoiceCustomerCard extends pw.StatelessWidget {
  InvoiceCustomerCard({required this.order});
  ...
  pw.Widget _addressCard({required String title, required dynamic address}) {
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          pw.Text("${address.city}, ${address.state}"),

          pw.Text("${address.country} - ${address.pincode}"),
        ],
      ),
    );
  }
