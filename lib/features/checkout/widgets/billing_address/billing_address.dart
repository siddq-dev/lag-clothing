...
class _BillingAddressState extends State<BillingAddress> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Form(
        key: _formKey,
        onChanged: _saveBillingAddress,
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("Billing Address", style: AppTextStyles.heading2),

            const SizedBox(height: 8),

            Text(
              "Enter your billing address for this order.",
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              "Saved profile billing address found: "
              "${savedAddress.city}, "
              "${savedAddress.state}. "
              "You can use it as a reference while entering your address.",
              style: AppTextStyles.bodyLarge,
            ),
          ),
        ],
