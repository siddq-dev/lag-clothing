...
class _PricingSectionState extends State<PricingSection> {
  ...
  void initState() {
    ...
    _priceController = TextEditingController(
      text: provider.form.price == 0 ? "" : provider.form.price.toString(),
    );
  ...
  Widget build(BuildContext context) {
    ...
    if (_priceController.text !=
        (provider.form.price == 0 ? "" : provider.form.price.toString())) {
      _priceController.text = provider.form.price == 0
          ? ""
    ...
    if (_salePriceController.text !=
        (provider.form.salePrice == 0
            ? ""
            : provider.form.salePrice.toString())) {
      _salePriceController.text = provider.form.salePrice == 0
          ? ""
          : provider.form.salePrice.toString();
    }
