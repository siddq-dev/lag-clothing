...
class _BasicInformationSectionState extends State<BasicInformationSection> {
  ...
  void initState() {
    ...
    _nameController = TextEditingController(text: provider.form.name);

    _descriptionController = TextEditingController(
      text: provider.form.description,
    );

    _brandController = TextEditingController(text: provider.form.brand);
  ...
  Widget build(BuildContext context) {
    ...
    if (_nameController.text != provider.form.name) {
      _nameController.value = TextEditingValue(
        ...
        selection: TextSelection.collapsed(offset: provider.form.name.length),
      );
    }
    ...
    if (_brandController.text != provider.form.brand) {
      _brandController.value = TextEditingValue(
        ...
        selection: TextSelection.collapsed(offset: provider.form.brand.length),
      );
    }
