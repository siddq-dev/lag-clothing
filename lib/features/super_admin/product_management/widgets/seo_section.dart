...
class _SeoSectionState extends State<SeoSection> {
  ...
  void initState() {
    ...
    _slugController = TextEditingController(text: provider.form.seo.slug);
  }
  ...
  void didChangeDependencies() {
    ...
    _metaDescriptionController.text = provider.form.seo.metaDescription;
  ...
  Widget build(BuildContext context) {
    ...
    if (_metaDescriptionController.text != provider.form.seo.metaDescription) {
      _metaDescriptionController.text = provider.form.seo.metaDescription;
    }
