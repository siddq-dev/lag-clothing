...
class _CustomerDetailsPageState extends State<CustomerDetailsPage> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      context.read<CustomerManagementProvider>().loadCustomer(widget.customer);
    });
  }
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Customer Profile
                      //------------------------------------
                      CustomerProfileCard(customer: provider.selectedCustomer!),
                      ...
                      CustomerStatisticsCard(
                        ...
                        totalSpend: provider.totalSpend,
                        averageOrder: provider.averageOrderValue,
                        lastOrder: provider.lastOrder,
                      ),
                      ...
                      if (provider.currentOrder != null)
                        CurrentOrderCard(order: provider.currentOrder!),
                      ...
                      // Previous Orders
                      //------------------------------------
                      PreviousOrdersSection(orders: provider.orders),
                    ],
                  ),
                ),
              ),
