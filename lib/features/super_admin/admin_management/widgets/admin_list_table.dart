...
class AdminListTable extends StatefulWidget {
  ...
  @override
  State<AdminListTable> createState() =>
      _AdminListTableState();
}

class _AdminListTableState
    extends State<AdminListTable> {
  ...
  Widget build(BuildContext context) {
    ...
    final provider =
        context.watch<AdminManagementProvider>();
